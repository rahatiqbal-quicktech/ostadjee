...
import 'package:ostadjee/app/modules/profile/widgets/candidate_payment_list_widget.dart';
...
class CandidatePaymentHistoryView extends GetView<FrontendController> {
  CandidatePaymentHistoryView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SafeArea(
        child: CandidatePaymentListWidget(),
      ),
    );
  }
}

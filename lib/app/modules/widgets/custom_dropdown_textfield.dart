...
import 'package:ostadjee/app/common/util/validators.dart';

class CustomDropdownTextField<T> extends StatelessWidget {
  final String title;
  final ValueChanged<T?> onChanged;
  final FormFieldSetter<T>? onSaved;
  final List<T>? dataList; // added null check later for tutor departments
  ...
  Widget build(BuildContext context) {
    return dataList!.isNotEmpty // added null check later for tutor departments
        ? Row(
            children: [
              if (prefixIcon != null)
                SizedBox(
                  ...
                  child: DropdownButtonFormField<T>(
                    ...
                    items: dataList
                        ?.map<DropdownMenuItem<T>>(
                          // added null check later for tutor departments

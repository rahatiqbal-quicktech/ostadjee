                  ...
                  child: Column(
                    children: [
                      if (controller.slider.value.sliders?.isNotEmpty ?? false)
                        CustomSliderWidget(
                            slider: controller.slider.value.sliders),
                      ListTile(
                        onTap: () {
                      ...
                      if (!controller.tutor.value) const TutorsListWidget(),
...
//                 if (!controller.tutor.value)
//                   Obx(() {
//                     return TutorsListWidget(controller: allTutorsController);
//                   }),

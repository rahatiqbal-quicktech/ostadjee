...
class AppColors {
  ...
  static const Color kPrimaryColor = Color(0xFF0F2182);
  static const Color mineShaft = Color(0xFF2B2B2B);
  static const Color lightGray = Color.fromARGB(255, 239, 244, 247);
  ...
  static const Color orange = Color(0xFFE86103);
